                                    ...
                                    <div className="px-4 sm:px-6">
                                        <div className='flex items-start justify-end'>
                                            <div className='ml-3 flex h-7 items-center'>
                                                <button type="button"
                                                        className="rounded-md bg-white text-slate-500 hover:text-slate-600 focus:outline-none focus:ring-2 focus:ring-cyan-600 focus:ring-offset-2"
                                                        onClick={onClose}>
                                    ...
                                    <div className='relative mt-6 flex-1 px-4 sm:px-6'>
                                        <div className='flex flex-col items-center'>
                                            ...
                                            <div className='flex gap-10 my-8'>
                                                <div  onClick={()=>setConfirmOpen(true)} className="flex flex-col gap-3 items-center cursor-pointer hover:opacity-68">
